                    ...
                    <div class="row product-categorie-box">
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                <div class="row">
                                    <p> Sorry the product you have searched is currently not available... Please try again later.. </p>
                                </div>
                            </div>
                        </div>
                    </div>
...
//GET ALL PRODUCTS - To retrieve all products - GRIDVIEW call this API ... 
...
//GET ALL PRODUCTS - To retrieve all products - LISTVIEW call this API ... 
...
app.get('/get_men_products',function(req, res) {
    ...
    resulthtml =`<html>
        ...
        and XXSKU.STYLE_ITEM = XXPS.ITEM_NUMBER
        AND XXSKU.CATALOGUE_CATEGORY=XXPC.COMMODITY
        AND (upper(XXPC.COMMODITY_NAME) like upper('men%')
        OR upper(XXPC.COMMODITY_NAME) like upper('boy%')
        )`;
...
//GET ALL PRODUCTS - To retrieve all women products call this API ...
app.get('/get_women_products',function(req, res) {
    ...
    resulthtml =`<html>
        ...
        and XXSKU.STYLE_ITEM = XXPS.ITEM_NUMBER
        AND XXSKU.CATALOGUE_CATEGORY=XXPC.COMMODITY
        AND (upper(XXPC.COMMODITY_NAME) like upper('women%')
        OR upper(XXPC.COMMODITY_NAME) like upper('girl%')
        )`;
